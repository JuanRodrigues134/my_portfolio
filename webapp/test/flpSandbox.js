		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Meu Portfólio",
									"targetURL": "#comrrsolutionsmyportfolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrrsolutionsmyportfolio-display": {
								"semanticObject": "comrrsolutionsmyportfolio",
								"action": "display",
								"description": "Meu Portfólio SAPUI5",
								"title": "Meu Portfólio",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rrsolutions.myportfolio",
									"url": sap.ui.require.toUrl("com/rrsolutions/myportfolio")
								}
							}
						}
					}
